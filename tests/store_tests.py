...
for expected in (
    ...
    'Notion','Ditto','Recuva','Bandizip','FastCopy','LightBulb','AutoIt','Obsidian',
    'Opera GX','Waterfox',
    ...
    'yt-dlp','ImageMagick','Shotcut','Picard','XnView MP',
    'EA app','Ubisoft Connect','GeForce Experience','Logitech G HUB',
    'Session','Jitsi Meet',
    'KeePass','Proton VPN','Mullvad VPN','YubiKey Manager','Eraser','BleachBit',
